...
import 'package:mobile_app_cognitive_rehabilitation/app/configuration/environment.dart';

class ApiProvider {
  late String pokedexBaseAddress;
  late String secretKey;

  ApiProvider() {
    pokedexBaseAddress = environment!.apiBaseAddress!;
...
class API {
  ...
  String _buildUri(
    ...
    switch (api) {
      case ApiChannel.pokedex:
      default:
        authorityUri = "${_apiProvider.pokedexBaseAddress}";
